<div class="mt-2 mx-lg-3 mx-0 px-3 py-3 work-desk position-relative " id="customer-{{$customer->id}}" >
    ...
    <div class="pb-1 position-relative" style="border-bottom:1px solid rgba(0,0,0,0.2);">
        <span class=" font-weight-bold cust-company"> {{ $customer->taskable->company }} </span>
    ...
    <div class="d-flex mt-2">
        <div class="deal-text sf-bold mb-0 d-flex align-items-start">
            ...
            <span class="pl-1 cust-date1 change-color" style="{{ isset($customer->status) != null ? 'color:'.$customer->status->color.';' : 'color:#C4C4C4;'}}">
        ...
        <div class="deal-text sf-bold mb-0 d-flex align-items-start ml-2">
            ...
            </svg><span class="pl-1 cust-date2 change-color" style="{{ isset($customer->status) != null ? 'color:'.$customer->status->color.';' : 'color:#C4C4C4;'}}">
