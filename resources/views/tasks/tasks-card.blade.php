...
?>
<div class="mt-2 mx-lg-3 mx-0 px-3 py-3 work-desk position-relative potencial-show" id="task-{{$task->id}}" >
    {{--    @dd($meeting)--}}
    ...
    <div class="pb-1 position-relative" style="border-bottom:1px solid rgba(0,0,0,0.2);">
        ...
        <div class="btn-group dropleft col-1 position-absolute" style="top:0%; right:-4%;">
            @if($task->active !=0 or auth()->user()->role=='admin')
    ...
    <div class="d-flex mt-2">
        <div class="deal-text sf-bold mb-0 d-flex align-items-start">
            ...
            <span class="pl-1 task-date1 change-color" style="{{'color:'.$color}}">
        ...
        <div class="deal-text sf-bold mb-0 d-flex align-items-start ml-2">
            ...
            </svg><span class="pl-1 task-date2 change-color" style="{{'color:'.$color}}">
    ...
    {{--</div>--}}
    <div class="status-task position-absolute h-100" style="width:3px; background-color:{{$color}}; top:0%; left:0%; "></div>
