...
{{--    @dd($meeting)--}}
    ...
    <div class="d-flex mt-2">
        <div class="deal-text sf-bold mb-0 d-flex align-items-start">
            ...
            <span class="pl-1 meet-date1" style="{{ isset($meeting->status) != null ? 'color:'.$meeting->status->color.';' : 'color:#C4C4C4;'}}">
        ...
        <div class="deal-text sf-bold mb-0 d-flex align-items-start ml-2">
            ...
            </svg><span class="pl-1 meet-date2" style="{{ isset($meeting->status) != null ? 'color:'.$meeting->status->color.';' : 'color:#C4C4C4;'}}">
    ...
    {{--</div>--}}
    <div class="status-met position-absolute h-100" style="width:3px; background-color: {{ isset($meeting->status) != null ? $meeting->status->color : '#C4C4C4'}}; top:0%; left:0%; "></div>
</div>
