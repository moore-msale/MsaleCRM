...
<div class="mt-2 mx-lg-3 mx-0 px-3 py-3 work-desk position-relative potencial-show" id="meet-{{$task->id}}" >
    ...
    <div class="d-flex mt-2">
        <div class="deal-text sf-bold mb-0 d-flex align-items-start">
            ...
            <span class="pl-1 meet-date1 change-color" style="{{'color:'.$color}}">
        ...
        <div class="deal-text sf-bold mb-0 d-flex align-items-start ml-2">
            ...
            </svg><span class="pl-1 meet-date2 change-color" style="{{'color:'.$color}}">
    ...
    <div class="status-meet position-absolute h-100" style="width:3px; background-color: {{$color}}; top:0%; left:0%; "></div>
</div>
@if(auth()->user()->role=='admin')
