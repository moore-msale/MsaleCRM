<div class="mt-3 mx-lg-3 mx-0 px-3 py-3 work-desk position-relative mainer"
     style="text-transform: uppercase;" id="meet-{{$meeting->id}}">
    ...
    <div style="border-bottom:1px solid #DCDCDC;">
        <p class="deal-text sf-bold mb-2">
            {{--@dd($meeting);--}}
            <i class="far fa-user"></i><span class="pl-1">{{ $meeting->taskable->customer->name }}</span>
        </p>
            ...
            <div id="collapsedone{{$meeting->id}}" class="collapse mt-1" role="tabpanel" aria-labelledby="heading96"
                ...
                <form action="" class="text-right">
                                        <textarea placeholder="Введите детали"
                                                  ...
                                                  rows="4" name="" id="details_done_Meet" style="outline: none;"></textarea>
                    <a href="#collapsedone{{$meeting->id}}" data-toggle="collapse" data-id="{{$meeting->id}}"
            ...
            <div id="collapsedelete{{$meeting->id}}" class="collapse mt-1" role="tabpanel" aria-labelledby="heading96"
                ...
                <form action="" class="text-right">
                                        <textarea placeholder="Введите причину удаления"
                                                  class="w-100 grey lighten-5 border-0 sf-light textarea-font-size"
                                                  rows="4" name="" id="details_delete_Meet" style="outline: none;"></textarea>
                    <a href="#collapsedelete{{$meeting->id}}" data-toggle="collapse" data-id="{{$meeting->id}}"
            ...
            <div id="collapseupdate{{$meeting->id}}" class="collapse mt-1" role="tabpanel" aria-labelledby="heading96"
                ...
                <form action="" class="text-right">
                                        <textarea placeholder="Введите причину изменения"
                                                  class="w-100 grey lighten-5 border-0 sf-light textarea-font-size"
                                                  rows="4" name="" id="details_update_Meet" style="outline: none;"></textarea>
                    <div class="md-form">
                        <input type="text" name="deadline_date" placeholder="Выберите дату" value="{{$meeting->deadline_date}}" id="meetchangedate" class="form-control date-format">
                    </div>
                    <a href="#collapseupdate{{$meeting->id}}" data-toggle="collapse" data-id="{{$meeting->id}}"
