...
{{--    @dd($meeting)--}}
    ...
    <div class="cust-company pb-1 position-relative" style="border-bottom:1px solid rgba(0,0,0,0.2);">
        <div class="font-weight-bold cust-company sf-medium"> {{ $meeting->taskable->customer->company }} </div>
        <div class="font-weight-light sf-light" style="color:rgba(0,0,0,0.4); font-size: 12px;">sfdsf</div>
    ...
    <div class="d-flex mt-2">
        <div class="deal-text sf-bold mb-0 d-flex align-items-start">
            ...
            <span class="pl-1 cust-date1" style="{{ isset($meeting->status) != null ? 'color:'.$meeting->status->color.';' : 'color:#C4C4C4;'}}">
        ...
        <div class="deal-text sf-bold mb-0 d-flex align-items-start ml-2">
            ...
            </svg><span class="pl-1 cust-date2" style="{{ isset($meeting->status) != null ? 'color:'.$meeting->status->color.';' : 'color:#C4C4C4;'}}">
