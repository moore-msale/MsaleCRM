<div class="mt-3 mx-lg-3 mx-0 px-3 py-3 work-desk position-relative potencial-show" id="customer-{{$customer->taskable->id}}" >
    ...
    <div class="d-flex mt-2">
        <div class="deal-text sf-bold mb-0 d-flex align-items-start">
            ...
            <span class="pl-1 cust-date1" style="{{ isset($customer->status) != null ? 'color:'.$customer->status->color.';' : 'color:#C4C4C4;'}}">
                {{ \Carbon\Carbon::parse($customer->deadline_date)->format('d M') }}
            </span>
        </div>
        <div class="deal-text sf-bold mb-0 d-flex align-items-start ml-2">
            ...
            </svg><span class="pl-1 cust-date2" style="{{ isset($customer->status) != null ? 'color:'.$customer->status->color.';' : 'color:#C4C4C4;'}}">
                {{ \Carbon\Carbon::parse($customer->deadline_date)->format('H:i') }}
            </span>
        </div>
        <div class="deal-text sf-bold mb-0 d-flex align-items-start ml-2">
        ...
        {{--</div>--}}
    <div class="status-met position-absolute h-100" style="width:3px; background-color: {{ isset($customer->status) != null ? $customer->status->color : '#C4C4C4'}}; top:0%; left:0%; "></div>
</div>
