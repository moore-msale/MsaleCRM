<div class="mt-3 mx-lg-3 mx-0 px-3 py-3 work-desk position-relative potencial-show"
    ...
    <div class="cust-company pb-1 position-relative" style="border-bottom:1px solid rgba(0,0,0,0.2);">
        <img src="{{ asset('images/company.svg') }}" alt=""><span class="ml-2 font-weight-bold"> {{ $customer->taskable->company }} </span>
    ...
    <div class="d-flex mt-2">
        <div class="deal-text sf-bold mb-0 d-flex align-items-start">
            ...
            <span class="pl-1 cust-name" style="{{ isset($customer->status) != null ? 'color:'.$customer->status->color.';' : 'color:#C4C4C4;'}}">
        ...
        <div class="deal-text sf-bold mb-0 d-flex align-items-start ml-2">
            ...
            </svg><span class="pl-1 cust-name" style="{{ isset($customer->status) != null ? 'color:'.$customer->status->color.';' : 'color:#C4C4C4;'}}">
