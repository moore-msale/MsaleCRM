<div class="mt-3 mx-lg-3 mx-0 px-3 py-3 work-desk position-relative potencial-show"
     style="text-transform: uppercase; cursor: pointer;" id="customer-{{$customer->taskable->id}}"  data-toggle="modal" data-target="#EditCustomer-{{ $customer->id }}">
