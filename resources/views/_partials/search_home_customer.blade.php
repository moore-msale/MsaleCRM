                        ...
                        @if($value->task->user_id==auth()->id() or auth()->user()->role=='admin')
                            ...
                            @if(isset($value->task))
                                @if(auth()->user()->role=='admin')
                                    <div class="nav-link products px-2 rows-hover  home-search" data-toggle="modal" data-target="#EditCustomerAdmin-{{$value->task->id}}" data-id="{{$value->task->id}}">
                                @else
                                    <div class="nav-link products px-2 rows-hover  home-search" data-toggle="modal" data-target="#EditCustomer-{{$value->task->id}}" data-id="{{$value->task->id}}">
                                @endif
