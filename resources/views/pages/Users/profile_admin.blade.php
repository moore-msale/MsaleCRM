             ...
             <div class="shadow bg-white">
                    ...
                    <div class="mt-4 p-5">
                        <form action="{{route('editUser')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-2">
                                <input type="text" name="phone" id="phone-{{$manager->id}}" class="form-control rounded-0 border-0  bg-grey sf-medium display-6" value="{{ $manager->phone }}" placeholder="Номер">
                            </div>
                            <div class="form-group mb-2">
