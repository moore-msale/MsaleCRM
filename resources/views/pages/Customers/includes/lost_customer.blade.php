<div class="row py-2 task-point" id="lostcustomer-{{$customer->id}}" style="{{$customer->chief != null ? 'border-left: 1px solid red;' : ''}}">
    ...
    <div class="col-2 text-center">
            <button class="btn py-2 px-3 task-name task-button text-white" style="background:#ff5965; opacity: 1;" disabled>
                Неудача
            </button>
    </div>
