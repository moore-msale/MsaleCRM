<div class="row py-2 task-point task-{{$task->id}}" id="" style="{{$task->chief != null ? 'border-left: 1px solid red;' : ''}}">
    ...
    <div class="col-3 d-flex align-items-center justify-content-center">
        <i class="far fa-check-circle fa-sm mr-3 ico-done task-ico" data-toggle="modal" data-target="#DoneTaskAdmin-{{$task->id}}" style="cursor:pointer;" title="Завершить задачу"></i>
