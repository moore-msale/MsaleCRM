...
<div class="modal fade right" id="AddPotencial" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
        ...
        <div class="modal-content px-2">
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="meetings" name="type">
                    <input type="hidden" id="customer_user" value="{{ auth()->id() }}" name="type">
